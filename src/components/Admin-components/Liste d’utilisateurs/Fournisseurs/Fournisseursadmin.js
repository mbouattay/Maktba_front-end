...
const CLINET = Alluser.filter(product => 
    product?.role?.toLowerCase()?.includes("fournisseur")
  );
  ...
  return (
   ...
   <div>   <h1 className="title-page-categorie">Liste de Fournisseurs</h1></div>
...
export default Fournisseursadmin
